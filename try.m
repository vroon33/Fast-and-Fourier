...
% peak_freq_matrix = zeros(num_chunks, 3);
% time_vector = zeros(num_chunks, 1);
...
for chunk_idx = 1:num_chunks
    ...
    % time_vector(chunk_idx) = (chunk_idx-1)*chunk_duration;
...
plotChunkFFT(31, chunk_samples, overlap, y, Fs);
